...
The project kicked off with a refinement session (a recorded transcript is in the repo), where the team — Gosia, Kasia, Jędrzej, Pati, Kacper, and Zenobia — worked through the problem space together. Gosia framed the human need: students spend roughly half their study time just _figuring out what to study_, leaving the other half for actual learning. Her own neurodivergent child was part of the inspiration.
